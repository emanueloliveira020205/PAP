      ...
      <div class="main-content">
        <section class="section">
         ...
         <!-- <div class="section-body">
			...
			<?php if ($estado=='todas'){
									$qry="Select * from vacas where ativo = 0 order by numero";
                      ...
                      <tbody>
						...
						<?php $url = 'sessaovacaqr.php?'.$row['numero'];?>
						  ...
						  <?php if ($_SESSION['tipo']==1){ ?>
							<td><button onclick="window.location.href='vacas_delete?<?php echo $row['numero']; ?>';" class="btn btn-primary btn-lg btn-block">Eliminar</button></td>
							<?php }?>
                        </tr>
                      </tbody>
					  <?php	}?>
